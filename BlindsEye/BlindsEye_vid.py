...
#Loading the Video
cap=cv2.VideoCapture(0) #openCV takes "0" as webcam
...
while True:
    ...
    if len(indexes)>0:
        for i in indexes.flatten():
            ...
            #Printing identified objects into the console
            #print(label)
            ...
            upload_to_cloud(collection, ip_address, timestamp, label, confidence)
